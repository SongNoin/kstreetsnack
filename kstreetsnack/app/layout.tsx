  ...
  "@graph": [
    {
      ...
      url: `${rootUrl}/`,
      name: "K Street Snack",
      alternateName: ["K-Street Snack", "K-Street K-Snack", "K Street Snack Wrocław"],
    ...
    },
    {
      ...
      "@id": restaurantId,
      name: "K Street Snack",
      alternateName: ["K-Street Snack", "K-Street K-Snack", "K Street Snack Wrocław", "K Snack Wrocław", "케이 스트리트 스낵"],
      description:
...
export const metadata: Metadata = {
  ...
  keywords: [
    "K Street Snack Wrocław",
    "K-Street Snack",
    "K Street Snack",
    "korean street food Wrocław",
    "koreański street food Wrocław",
    "koreańskie jedzenie Wrocław",
    "kuchnia koreańska Wrocław",
    "restauracja koreańska Wrocław",
